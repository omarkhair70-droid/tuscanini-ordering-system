...
export function StoryPreview() {
  return (
    <section className="surface-card space-y-2.5">
      ...
      <Link href="/about" className="inline-block pt-1 text-sm font-extrabold text-brand-red underline decoration-2 underline-offset-4">
