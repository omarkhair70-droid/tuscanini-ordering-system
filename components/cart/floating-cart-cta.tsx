...
export function FloatingCartCta() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-20 z-30 px-4 md:hidden">
      <Link
        href="/cart"
        className="pointer-events-auto flex items-center justify-between rounded-xl2 bg-brand-red px-4 py-3 text-brand-white shadow-punch"
      >
