...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-brand-dark/10 bg-brand-white/96 shadow-[0_-6px_18px_rgba(18,18,18,0.06)] backdrop-blur md:hidden">
